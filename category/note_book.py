...
# URL to scrape
url = "https://v-tel.co.za/product-category/note-book/"
url_ = "https://v-tel.co.za/product-category/note-book/page/2/"
...
"""import csv
with open("note_book.csv", "w", newline="", encoding="utf-8") as file:
