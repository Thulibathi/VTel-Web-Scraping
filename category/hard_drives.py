...
# URL to scrape
url = "https://v-tel.co.za/product-category/hard-drives/"
url_ = "https://v-tel.co.za/product-category/hard-drives/page/2/"
...
file_path = os.path.join(output_folder, "hard_drives.csv")
