...
# URL to scrape
url = "https://v-tel.co.za/product-category/flash-drive/"
url_ = "https://v-tel.co.za/product-category/flash-drive/page/2/"
...
file_path = os.path.join(output_folder, "flash_drive.csv")
